...
extension UIFont {
    class var blackCardFont: UIFont {
        get {
            return UIFont.boldSystemFontOfSize(screenScaledFontSize(35))
        }
    }
    class var whiteCardFont: UIFont {
        get {
            return UIFont.boldSystemFontOfSize(screenScaledFontSize(20))
        }
    }
    class var voteButtonFont: UIFont {
        get {
            return UIFont.systemFontOfSize(screenScaledFontSize(17))
        }
    }
}
